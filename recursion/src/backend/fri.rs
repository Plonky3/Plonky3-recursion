...
use p3_circuit_prover::batch_stark_prover::{
    OpenInputAirBuilderD1, OpenInputAirBuilderD2, OpenInputAirBuilderD4, OpenInputPreprocessor,
    OpenInputProver, OpenInputProverD2, poseidon2_air_builders_d2, poseidon2_air_builders_d4,
    poseidon2_preprocessor, poseidon2_table_provers_d2, poseidon2_table_provers_d4,
};
...
where
    ...
    OpenInputPreprocessor: NpoPreprocessor<Val<SC>>,
    SC::Challenge: BasedVectorSpace<Val<SC>>
        + From<Val<SC>>
        + ExtensionField<Val<SC>>
        + PrimeCharacteristicRing
