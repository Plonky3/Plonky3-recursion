...
use p3_circuit_prover::{
    Poseidon2Preprocessor, RecomposePreprocessor, TableProver, poseidon2_table_provers,
        ...
        >,
{
    ...
    fn non_primitive_provers(&self, ext_degree: usize) -> Vec<Box<dyn TableProver<SC>>> {
        if ext_degree == 2 {
            let mut provers = poseidon2_table_provers::<SC, 2>(self.0.challenger_perm_config);
        ...
        >,
{
    ...
    fn non_primitive_provers(&self, ext_degree: usize) -> Vec<Box<dyn TableProver<SC>>> {
        if ext_degree == 4 {
            let mut provers = poseidon2_table_provers::<SC, 4>(self.0.challenger_perm_config);
