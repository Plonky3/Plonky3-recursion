...
impl<F: Field + Clone> Clone for Op<F> {
    fn clone(&self) -> Self {
        match self {
            ...
            Self::Alu { kind, a, b, c, out } => Self::Alu {
                kind: *kind,
                a: *a,
                b: *b,
                c: *c,
